...
const en: Dictionary = {
  ...
  "proj.title": "Projects",
  "proj.subtitle": "Each project is a workspace where the whole history of the work collects",
  "proj.new": "New project",
  "proj.create": "Create project",
  "proj.empty": "No projects yet",
  "proj.emptyHint": "Open the first project and its history starts collecting in it.",
  "proj.threadsCount": "chats",
  "proj.lastActivity": "Last activity",
  "proj.noActivity": "not yet",
  "proj.awaiting": "Waiting for acceptance",
  "proj.overdue": "Overdue",
  "proj.inProgress": "In progress",
  "proj.done": "Completed",
  "proj.status.REJA": "Planned",
  "proj.status.FAOL": "Active",
  "proj.status.PAUZA": "Paused",
  "proj.status.YAKUNLANMOQDA": "Wrapping up",
  "proj.status.YAKUNLANDI": "Finished",
  "proj.field.name": "Project name",
  "proj.field.namePlaceholder": "For example, Smart City",
  "proj.field.description": "Description",
  "proj.field.status": "Status",
  "proj.field.stage": "Stage",
  "proj.field.owner": "Responsible",
  "proj.field.started": "Started",
  "proj.field.deadline": "Deadline",
  "proj.newThread": "New chat",
  "proj.threads": "Chats",
  "proj.noThreads": "No chats yet",
  "proj.noThreadsHint": "Open a chat for each organisation or workstream — the history collects there.",
  "proj.waitingTitle": "Not accepted yet",
  "proj.waitingEmpty": "Every assignment has been accepted",
  "proj.openAgreements": "Open agreements",
  "proj.noAgreements": "No open agreements",
  "thread.field.title": "Who or what this is about",
  "thread.field.titlePlaceholder": "For example, UNIDO",
  "thread.field.kind": "Kind",
  "thread.field.entryKind": "Entry kind",
  "thread.kind.ORG": "Organisation",
  "thread.kind.DIRECTION": "Workstream",
  "thread.kind.INTERNAL": "Internal team",
  "thread.create": "Create chat",
  "thread.pinned": "Marked as important",
  "thread.empty": "Nothing recorded yet",
  "thread.emptyHint": "Write down what happened — months later these records are what rebuild the whole story.",
  "thread.recordedLater": "recorded later",
  "thread.edited": "edited",
  "thread.agreement": "Agreement",
  "thread.task": "Assignment",
  "thread.entryActions": "Entry actions",
  "thread.pin": "Mark",
  "thread.unpin": "Unmark",
  ...
  "thread.entry.MEETING": "Meeting",
  "thread.when": "Date",
  "thread.whenHint": "When did this happen?",
  "thread.attach": "Attach",
  "thread.link": "Link",
  "thread.asAgreement": "As an agreement",
  "thread.asTask": "Assign a task",
  "thread.assignee": "Assign to",
  "thread.owner": "Owner",
  "thread.ownerNone": "Not chosen",
  "thread.deadline": "Deadline",
  "thread.record": "Record",
  "thread.removeFile": "Remove file",
  "thread.taskNeedsOwner": "An assignment needs text and somebody to do it.",
  "thread.agreementNeedsText": "Write down what was agreed.",
  "accept.sent": "Sent",
  "accept.seen": "Seen",
  "accept.notSeen": "Not opened",
  "accept.accepted": "Accepted",
  "accept.notAccepted": "Not accepted",
