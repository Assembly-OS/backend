const uz = {
  ...
  "proj.title": "Loyihalar",
  "proj.subtitle": "Har bir loyiha — ish tarixi to'planadigan alohida makon",
  "proj.new": "Yangi loyiha",
  "proj.create": "Loyihani ochish",
  "proj.empty": "Hozircha loyiha yo'q",
  "proj.emptyHint": "Birinchi loyihani oching — ish tarixi o'sha yerda to'plana boshlaydi.",
  "proj.threadsCount": "suhbat",
  "proj.lastActivity": "So'nggi harakat",
  "proj.noActivity": "hali yo'q",
  "proj.awaiting": "Qabul kutilmoqda",
  "proj.overdue": "Muddati o'tgan",
  "proj.inProgress": "Bajarilmoqda",
  "proj.done": "Bajarildi",
  "proj.status.REJA": "Reja",
  "proj.status.FAOL": "Faol",
  "proj.status.PAUZA": "To'xtatilgan",
  "proj.status.YAKUNLANMOQDA": "Yakunlanmoqda",
  "proj.status.YAKUNLANDI": "Yakunlandi",
  "proj.field.name": "Loyiha nomi",
  "proj.field.namePlaceholder": "Masalan, Smart City",
  "proj.field.description": "Tavsif",
  "proj.field.status": "Holat",
  "proj.field.stage": "Bosqich",
  "proj.field.owner": "Mas'ul",
  "proj.field.started": "Boshlangan",
  "proj.field.deadline": "Muddat",
  "proj.newThread": "Yangi suhbat",
  "proj.threads": "Suhbatlar",
  "proj.noThreads": "Suhbatlar hali ochilmagan",
  "proj.noThreadsHint": "Har bir tashkilot yoki yo'nalish uchun alohida suhbat oching — tarix o'sha yerda to'planadi.",
  "proj.waitingTitle": "Hali qabul qilinmagan",
  "proj.waitingEmpty": "Barcha topshiriqlar qabul qilingan",
  "proj.openAgreements": "Ochiq kelishuvlar",
  "proj.noAgreements": "Ochiq kelishuv yo'q",
  "thread.field.title": "Kim yoki nima haqida",
  "thread.field.titlePlaceholder": "Masalan, UNIDO",
  "thread.field.kind": "Turi",
  "thread.field.entryKind": "Yozuv turi",
  "thread.kind.ORG": "Tashkilot",
  "thread.kind.DIRECTION": "Yo'nalish",
  "thread.kind.INTERNAL": "Ichki jamoa",
  "thread.create": "Suhbatni ochish",
  "thread.pinned": "Muhim yozuvlar",
  "thread.empty": "Yozuvlar hali yo'q",
  "thread.emptyHint": "Nima bo'lganini yozib qo'ying — bir necha oydan keyin aynan shu yozuvlar butun tarixni tiklaydi.",
  "thread.recordedLater": "keyin yozilgan",
  "thread.edited": "tahrirlangan",
  "thread.agreement": "Kelishuv",
  "thread.task": "Topshiriq",
  "thread.entryActions": "Yozuv amallari",
  "thread.pin": "Belgilash",
  ...
  "thread.entry.MEETING": "Uchrashuv",
  "thread.when": "Sana",
  "thread.whenHint": "Bu qachon bo'lgan?",
  "thread.attach": "Hujjat",
  "thread.link": "Havola",
  "thread.asAgreement": "Kelishuv sifatida",
  "thread.asTask": "Topshiriq berish",
  "thread.assignee": "Kimga",
  "thread.owner": "Mas'ul",
  "thread.ownerNone": "Tanlanmagan",
  "thread.deadline": "Muddat",
  "thread.record": "Yozib qo'yish",
  "thread.removeFile": "Faylni olib tashlash",
  "thread.taskNeedsOwner": "Topshiriq uchun matn va ijrochi kerak.",
  "thread.agreementNeedsText": "Kelishuv matnini yozing.",
  "accept.sent": "Yuborildi",
  "accept.seen": "Ko'rdi",
  "accept.notSeen": "Ko'rmagan",
  "accept.accepted": "Qabul qildi",
  "accept.notAccepted": "Qabul qilmagan",
